...
/**
 * Testimonials — adapted from shadcn-studio/blocks/testimonials-component-01.
 * Carousel of customer testimonials with rating, avatar, and quote.
 */
      ...
      >
        ...
        <div className="space-y-4 sm:w-1/2 lg:w-1/3">
          ...
          <p className="text-muted-foreground text-xl">
            From career changes to dream restaurants, here&apos;s how Tablenary
            helped.
          </p>
